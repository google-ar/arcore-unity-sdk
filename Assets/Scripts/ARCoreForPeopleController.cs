...
{
    public class ARCoreForPeopleController : MonoBehaviour {

        /// <summary>
        /// The People Controller to use to place characters
        /// </summary>
        public PeopleController m_peopleController;
        ...
        public void ARUpdate ()
        {
            ...
            if (Session.Raycast (m_firstPersonCamera.ScreenPointToRay (touch.position), raycastFilter, out hit)) {
                ...
                GameObject andyObject = m_peopleController.PlaceCharacter (hit.Point, anchor.transform);
